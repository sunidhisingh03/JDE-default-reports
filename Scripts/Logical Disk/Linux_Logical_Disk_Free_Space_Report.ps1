...
$htmlReport1 | Out-File "Logical Disk Free Space for Linux HTML.html" -Force

$fileName = "Logical Disk Free Space for Linux Output.csv"
...
$params = @{
    ...
    Body = @{
        ...
        Content = @{
            Subject = 'JDE(IT) | Azure | Linux Logical Disk Free Space'
